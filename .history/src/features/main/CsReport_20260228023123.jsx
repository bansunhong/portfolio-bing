...
export default function CsReport() {
    ...
    return (
        <section className={styles.mainSection3}>
            {/* 고객문의 및 불편사항 section */}
            <motion.div className={styles.sectionQnaBlock} variants={container} initial="hidden" animate="show">
                <motion.h3 className={styles.sectionTitle} variants={item}>
                    고객문의 및 불편사항
                </motion.h3>
                <div className={styles.sectionQnaBox}>
                    <motion.div className={styles.qnaBoxBanners} variants={item}>
                    ...
                    <ul className={styles.qnaBoxList}>
                        {qnaList.map((item) => (
                            <motion.li
                                ...
                                initial="hidden"
                                animate="show"
                                transition={{ delay: 0.9 + index * 0.1 }} // 배너 뒤 순차적으로
                            >
