            ...
            <div ref={productRef} className={styles.sectionProductBlock}>
                ...
                <Slider {...productSettings} className={styles.sliderList}>
                    {productList.map((item, idx) => (
                        <div key={`${idx}-${productVisible}`} className={`${styles.sliderItem} ${productVisible ? styles.animate : ""}`} style={{ animationDelay: `${idx * 0.1}s` }}>
            ...
            <div ref={brandRef} className={styles.sectionBrandBlock}>
                ...
                <Slider {...brandSettings} className={styles.sliderList}>
                    {brandList.map((item, idx) => (
                        <div key={idx} className={`${styles.sliderItem} ${brandVisible ? styles.animate : ""}`} style={{ animationDelay: `${idx * 0.1}s` }}>
