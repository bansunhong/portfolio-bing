...
export default function ProductBrandSlider() {
    ...
    return (
        <section ref={sectionRef} className={styles.mainSection2}>
            {/* Product Section */}
            <div className={styles.sectionProductBlock}>
                ...
                <Slider {...productSettings} className={styles.sliderList}>
                    {reorderedProductList.map((item, idx) => (
                        <div key={idx} className={`${styles.sliderItem} ${isVisible ? styles.fadeUp : ""}`} style={{ transitionDelay: `${idx * 0.1}s` }}>
            ...
            {/* Brand Section */}
            <div className={styles.sectionBrandBlock}>
